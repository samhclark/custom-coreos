...
# Operations & Maintenance {#operations-maintenance .title .leading-10 .text-xl .lg:text-2xl .xl:text-3xl .text-garage-orange .font-semibold}
...
This section contains a number of important information on how to best
operate a Garage cluster, to ensure integrity and availability of your
data:

- **[Upgrading
  Garage](https://garagehq.deuxfleurs.fr/documentation/operations/upgrading/):**
  General instructions on how to upgrade your cluster from one version
  to the next. Instructions specific for each version upgrade can bef
  ound in the [working
  documents](https://garagehq.deuxfleurs.fr/documentation/working-documents/)
  section.

- **[Layout
  management](https://garagehq.deuxfleurs.fr/documentation/operations/layout/):**
  Best practices for using the `garage layout` commands when adding or
  removing nodes from your cluster.

- **[Durability and
  repairs](https://garagehq.deuxfleurs.fr/documentation/operations/durability-repairs/):**
  How to check for small things that might be going wrong, and how to
  recover from such failures.

- **[Recovering from
  failures](https://garagehq.deuxfleurs.fr/documentation/operations/recovering/):**
  Garage\'s first selling point is resilience to hardware failures. This
  section explains how to recover from such a failure in the best
  possible way.
:::
::::::
...
.h-6 .mx-auto} [Upgrading Garage]{.mt-0.5 .2xl:hidden}
]{.icon}](https://garagehq.deuxfleurs.fr/documentation/operations/upgrading/ "Upgrading Garage"){.flex
