...
- [Build your own
  ...
  .border .border-garage-orange .block .p-1 .rounded-r .rounded-tl
  .font-semibold .activePage .text-garage-orange .font-semibold
  .border-opacity-100 .border-garage-orange} ☐
  ![](data:image/svg+xml;base64,){.arrow
  .w-6 .h-6 .text-garage-gray .group-hover:text-garage-orange .transform
  .rotate-90}
...
# Build your own app {#build-your-own-app .title .leading-10 .text-xl .lg:text-2xl .xl:text-3xl .text-garage-orange .font-semibold}
...
In this section, we reference the existing SDKs and give some code
examples.

## ⚠️ DISCLAIMER {#warning-disclaimer}

**K2V AND ADMIN SDK ARE TECHNICAL PREVIEWS**. The following limitations
apply:

- The API is not complete, some actions are possible only through the
  `garage` binary
- The underlying admin API is not yet stable nor complete, it can breaks
  at any time
- The generator configuration is currently tweaked, the library might
  break at any time due to a generator change
- Because the API and the library are not stable, none of them are
  published in a package manager (npm, pypi, etc.)
- This code has not been extensively tested, some things might not work
  (please report!)
...
- Before upgrading your Garage cluster, make sure that you can find a
  version of this SDK that works with your targeted version and that you
  are able to update your own code to work with this new version of the
  library.
- Join our Matrix channel at `#garage:deuxfleurs.fr`, say that you are
  interested by this SDK, and report any friction.
- If stability is critical, mirror this repository on your own
  infrastructure, regenerate the SDKs and upgrade them at your own pace.

## About the APIs

Code can interact with Garage through 3 different APIs: S3, K2V, and
Admin. Each of them has a specific scope.

### S3

De-facto standard, introduced by Amazon, designed to store blobs of
data.

### K2V

A simple database API similar to RiakKV or DynamoDB. Think a key value
store with some additional operations. Its design is inspired by
Distributed Hash Tables (DHT).

More information:

- [In the reference
  manual](https://garagehq.deuxfleurs.fr/documentation/reference-manual/k2v/)

### Administration

Garage operations can also be automated through a REST API. We are
currently building this SDK for
[Python](https://garagehq.deuxfleurs.fr/documentation/build/python/#admin-api),
[Javascript](https://garagehq.deuxfleurs.fr/documentation/build/javascript/#administration)
and
[Golang](https://garagehq.deuxfleurs.fr/documentation/build/golang/#administration).

More information:

- [In the reference
  manual](https://garagehq.deuxfleurs.fr/documentation/reference-manual/admin-api/)
- [Full
  specifiction](https://garagehq.deuxfleurs.fr/api/garage-admin-v0.html){rel="noopener nofollow noreferrer"
  target="_blank"}
:::
::::::
...
1.  [⚠️
    DISCLAIMER](https://garagehq.deuxfleurs.fr/documentation/build/#warning-disclaimer){.font-semibold
    .text-gray-800 .transition-all .hover:text-garage-orange}
2.  [About the
    APIs](https://garagehq.deuxfleurs.fr/documentation/build/#about-the-apis){.font-semibold
    .text-gray-800 .transition-all .hover:text-garage-orange}
    - [S3](https://garagehq.deuxfleurs.fr/documentation/build/#s3){#link-s3
      .toc .text-gray-700 .hover:text-garage-orange}
    - [K2V](https://garagehq.deuxfleurs.fr/documentation/build/#k2v){#link-k2v
      .toc .text-gray-700 .hover:text-garage-orange}
    - [Administration](https://garagehq.deuxfleurs.fr/documentation/build/#administration){#link-administration
      .toc .text-gray-700 .hover:text-garage-orange}
...
::: {.w-1/2 .lg:w-1/3}
[[
![](data:image/svg+xml;base64,){.w-6
.h-6 .mx-auto} [Javascript]{.mt-0.5 .2xl:hidden}
]{.icon}](https://garagehq.deuxfleurs.fr/documentation/build/javascript/ "Javascript"){.flex
