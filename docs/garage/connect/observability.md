...
# Observability {#observability .title .leading-10 .text-xl .lg:text-2xl .xl:text-3xl .text-garage-orange .font-semibold}
...
An object store can be used as data storage location for metrics, and
logs which can then be leveraged for systems observability.

## Metrics

### Prometheus

Prometheus itself has no object store capabilities, however two projects
exist which support storing metrics in an object store:

- [Cortex](https://cortexmetrics.io/){rel="noopener nofollow noreferrer"
  target="_blank"}
- [Thanos](https://thanos.io/){rel="noopener nofollow noreferrer"
  target="_blank"}
...
[Vector](https://vector.dev/){rel="noopener nofollow noreferrer"
target="_blank"} natively supports S3 as a [data
sink](https://vector.dev/docs/reference/configuration/sinks/aws_s3/){rel="noopener nofollow noreferrer"
target="_blank"} (and
[source](https://vector.dev/docs/reference/configuration/sources/aws_s3/){rel="noopener nofollow noreferrer"
target="_blank"}).
...
This is an example configuration - please refer to the Vector
documentation for all configuration and transformation possibilities.
Also note that Garage performs its own compression, so this should be
disabled in Vector.
:::
::::::
...
1.  [Metrics](https://garagehq.deuxfleurs.fr/documentation/connect/observability/#metrics){.font-semibold
    .text-gray-800 .transition-all .hover:text-garage-orange}
    - [Prometheus](https://garagehq.deuxfleurs.fr/documentation/connect/observability/#prometheus){#link-prometheus
      .toc .text-gray-700 .hover:text-garage-orange}
2.  [System
    logs](https://garagehq.deuxfleurs.fr/documentation/connect/observability/#system-logs){.font-semibold
    .text-gray-800 .transition-all .hover:text-garage-orange}
    - [Vector](https://garagehq.deuxfleurs.fr/documentation/connect/observability/#vector){#link-vector
      .toc .text-gray-700 .hover:text-garage-orange}
