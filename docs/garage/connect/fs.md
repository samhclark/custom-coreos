...
# FUSE (s3fs, goofys, s3backer\...) {#fuse-s3fs-goofys-s3backer... .title .leading-10 .text-xl .lg:text-2xl .xl:text-3xl .text-garage-orange .font-semibold}
...
**WARNING! Garage is not POSIX compatible. Mounting S3 buckets as
filesystems will not provide POSIX compatibility. If you are not
careful, you will lose or corrupt your data.**

Do not use these FUSE filesystems to store any database files (eg.
MySQL, Postgresql, Mongo or sqlite), any daemon cache (dovecot,
openldap, gitea, etc.), and more generally any software that use
locking, advanced filesystems features or make any synchronisation
assumption. Ideally, avoid these solutions at all for any serious or
production use.

## rclone mount

rclone uses the same configuration when used [in
CLI](https://garagehq.deuxfleurs.fr/documentation/connect/cli/) and
mount mode. We suppose you have the following entry in your `rclone.ini`
(mine is located in `~/.config/rclone/rclone.conf`):
...
*External link:* [rclone documentation \> rclone
mount](https://rclone.org/commands/rclone_mount/){rel="noopener nofollow noreferrer"
target="_blank"}

## s3fs

*External link:* [s3fs github \>
README.md](https://github.com/s3fs-fuse/s3fs-fuse#user-content-examples){rel="noopener nofollow noreferrer"
target="_blank"}

## goofys

*External link:* [goofys github \>
README.md](https://github.com/kahing/goofys#user-content-usage){rel="noopener nofollow noreferrer"
target="_blank"}

## s3backer

*External link:* [s3backer github \>
manpage](https://github.com/archiecobbs/s3backer/wiki/ManPage){rel="noopener nofollow noreferrer"
target="_blank"}

## csi-s3

*External link:* [csi-s3 Github \>
README.md](https://github.com/ctrox/csi-s3){rel="noopener nofollow noreferrer"
target="_blank"}
:::
::::::
...
1.  [rclone
    mount](https://garagehq.deuxfleurs.fr/documentation/connect/fs/#rclone-mount){.font-semibold
    .text-gray-800 .transition-all .hover:text-garage-orange}
2.  [s3fs](https://garagehq.deuxfleurs.fr/documentation/connect/fs/#s3fs){.font-semibold
    .text-gray-800 .transition-all .hover:text-garage-orange}
3.  [goofys](https://garagehq.deuxfleurs.fr/documentation/connect/fs/#goofys){.font-semibold
    .text-gray-800 .transition-all .hover:text-garage-orange}
4.  [s3backer](https://garagehq.deuxfleurs.fr/documentation/connect/fs/#s3backer){.font-semibold
    .text-gray-800 .transition-all .hover:text-garage-orange}
5.  [csi-s3](https://garagehq.deuxfleurs.fr/documentation/connect/fs/#csi-s3){.font-semibold
    .text-gray-800 .transition-all .hover:text-garage-orange}
