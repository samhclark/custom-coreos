...
# Cookbook {#cookbook .title .leading-10 .text-xl .lg:text-2xl .xl:text-3xl .text-garage-orange .font-semibold}
...
A cookbook, when you cook, is a collection of recipes. Similarly,
Garage\'s cookbook contains a collection of recipes that are known to
work well! This chapter could also be referred as \"Tutorials\" or
\"Best practices\".

- **[Multi-node
  deployment](https://garagehq.deuxfleurs.fr/documentation/cookbook/real-world/):**
  This page will walk you through all of the necessary steps to deploy
  Garage in a real-world setting.

- **[Building from
  source](https://garagehq.deuxfleurs.fr/documentation/cookbook/from-source/):**
  This page explains how to build Garage from source in case a binary is
  not provided for your architecture, or if you want to hack with us!

- **[Binary
  packages](https://garagehq.deuxfleurs.fr/documentation/cookbook/binary-packages/):**
  This page lists the different platforms that provide ready-built
  software packages for Garage.

- **[Integration with
  Systemd](https://garagehq.deuxfleurs.fr/documentation/cookbook/systemd/):**
  This page explains how to run Garage as a Systemd service (instead of
  as a Docker container).

- **[Configuring a gateway
  node](https://garagehq.deuxfleurs.fr/documentation/cookbook/gateways/):**
  This page explains how to run a gateway node in a Garage cluster, i.e.
  a Garage node that doesn\'t store data but accelerates access to data
  present on the other nodes.

- **[Hosting a
  website](https://garagehq.deuxfleurs.fr/documentation/cookbook/exposing-websites/):**
  This page explains how to use Garage to host a static website.

- **[Configuring a
  reverse-proxy](https://garagehq.deuxfleurs.fr/documentation/cookbook/reverse-proxy/):**
  This page explains how to configure a reverse-proxy to add TLS support
  to your S3 api endpoint.

- **[Deploying on
  Kubernetes](https://garagehq.deuxfleurs.fr/documentation/cookbook/kubernetes/):**
  This page explains how to deploy Garage on Kubernetes using our Helm
  chart.

- **[Deploying with
  Ansible](https://garagehq.deuxfleurs.fr/documentation/cookbook/ansible/):**
  This page lists available Ansible roles developed by the community to
  deploy Garage.

- **[Monitoring
  Garage](https://garagehq.deuxfleurs.fr/documentation/cookbook/monitoring/)**
  This page explains the Prometheus metrics available for monitoring the
  Garage cluster/nodes.
:::
::::::
...
.h-6 .mx-auto} [Deployment on a cluster]{.mt-0.5 .2xl:hidden}
]{.icon}](https://garagehq.deuxfleurs.fr/documentation/cookbook/real-world/ "Deployment on a cluster"){.flex
