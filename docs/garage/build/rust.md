...
# Rust {#rust .title .leading-10 .text-xl .lg:text-2xl .xl:text-3xl .text-garage-orange .font-semibold}
...
- Amazon aws-rust-sdk
  - [Github](https://github.com/awslabs/aws-sdk-rust){rel="noopener nofollow noreferrer"
    target="_blank"}
...
Some refs:
https://git.deuxfleurs.fr/Deuxfleurs/garage/src/branch/main/src/k2v-client
...
1.  [S3](https://garagehq.deuxfleurs.fr/documentation/build/rust/#s3){.font-semibold
    .text-gray-800 .transition-all .hover:text-garage-orange}
2.  [K2V](https://garagehq.deuxfleurs.fr/documentation/build/rust/#k2v){.font-semibold
    .text-gray-800 .transition-all .hover:text-garage-orange}
3.  [Admin
    API](https://garagehq.deuxfleurs.fr/documentation/build/rust/#admin-api){.font-semibold
    .text-gray-800 .transition-all .hover:text-garage-orange}
