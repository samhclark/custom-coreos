...
# Golang {#golang .title .leading-10 .text-xl .lg:text-2xl .xl:text-3xl .text-garage-orange .font-semibold}
...
- Minio minio-go-sdk
  ...
  - [Reference](https://docs.min.io/docs/golang-client-api-reference.html){rel="noopener nofollow noreferrer"
    target="_blank"}

- Amazon aws-sdk-go-v2

  - [Installation](https://aws.github.io/aws-sdk-go-v2/docs/getting-started/){rel="noopener nofollow noreferrer"
    target="_blank"}
  - [Reference](https://pkg.go.dev/github.com/aws/aws-sdk-go-v2/service/s3){rel="noopener nofollow noreferrer"
    target="_blank"}
  - [Example](https://aws.github.io/aws-sdk-go-v2/docs/code-examples/s3/putobject/){rel="noopener nofollow noreferrer"
    target="_blank"}
...
``` {.language-go data-lang="go" style="background-color:#2b303b;color:#c0c5ce;"}
package main
...
- [generated
  doc](https://git.deuxfleurs.fr/garage-sdk/garage-admin-sdk-golang){rel="noopener nofollow noreferrer"
  target="_blank"}
- [examples](https://git.deuxfleurs.fr/garage-sdk/garage-admin-sdk-generator/src/branch/main/example/golang){rel="noopener nofollow noreferrer"
  target="_blank"}
:::
::::::
...
1.  [S3](https://garagehq.deuxfleurs.fr/documentation/build/golang/#s3){.font-semibold
    .text-gray-800 .transition-all .hover:text-garage-orange}
2.  [K2V](https://garagehq.deuxfleurs.fr/documentation/build/golang/#k2v){.font-semibold
    .text-gray-800 .transition-all .hover:text-garage-orange}
3.  [Administration](https://garagehq.deuxfleurs.fr/documentation/build/golang/#administration){.font-semibold
    .text-gray-800 .transition-all .hover:text-garage-orange}
