...
# Javascript {#javascript .title .leading-10 .text-xl .lg:text-2xl .xl:text-3xl .text-garage-orange .font-semibold}
...
- Minio SDK
  ...
  - [Reference](https://docs.min.io/docs/javascript-client-api-reference.html){rel="noopener nofollow noreferrer"
    target="_blank"}

- Amazon aws-sdk-js

  - [Installation](https://docs.aws.amazon.com/sdk-for-javascript/v3/developer-guide/getting-started.html){rel="noopener nofollow noreferrer"
    target="_blank"}
  - [Reference](https://docs.aws.amazon.com/AWSJavaScriptSDK/latest/AWS/S3.html){rel="noopener nofollow noreferrer"
    target="_blank"}
  - [Example](https://docs.aws.amazon.com/sdk-for-javascript/v3/developer-guide/s3-example-creating-buckets.html){rel="noopener nofollow noreferrer"
    target="_blank"}
...
``` {.language-javascript data-lang="javascript" style="background-color:#2b303b;color:#c0c5ce;"}
...
- [sdk
  repository](https://git.deuxfleurs.fr/garage-sdk/garage-admin-sdk-js){rel="noopener nofollow noreferrer"
  target="_blank"}
- [examples](https://git.deuxfleurs.fr/garage-sdk/garage-admin-sdk-generator/src/branch/main/example/javascript){rel="noopener nofollow noreferrer"
  target="_blank"}
:::
::::::
...
1.  [S3](https://garagehq.deuxfleurs.fr/documentation/build/javascript/#s3){.font-semibold
    .text-gray-800 .transition-all .hover:text-garage-orange}
2.  [K2V](https://garagehq.deuxfleurs.fr/documentation/build/javascript/#k2v){.font-semibold
    .text-gray-800 .transition-all .hover:text-garage-orange}
3.  [Administration](https://garagehq.deuxfleurs.fr/documentation/build/javascript/#administration){.font-semibold
    .text-gray-800 .transition-all .hover:text-garage-orange}
