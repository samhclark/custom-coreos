...
# Others {#others .title .leading-10 .text-xl .lg:text-2xl .xl:text-3xl .text-garage-orange .font-semibold}
...
If you are developping a new application, you may want to use Garage to
store your user\'s media.

The S3 API that Garage uses is a standard REST API, so as long as you
can make HTTP requests, you can query it. You can check the [S3 REST API
Reference](https://docs.aws.amazon.com/AmazonS3/latest/API/API_Operations_Amazon_Simple_Storage_Service.html){rel="noopener nofollow noreferrer"
target="_blank"} from Amazon to learn more.

Developping your own wrapper around the REST API is time consuming and
complicated. Instead, there are some libraries already avalaible.

Some of them are maintained by Amazon, some by Minio, others by the
community.

### PHP

- Amazon aws-sdk-php
  - [Installation](https://docs.aws.amazon.com/sdk-for-php/v3/developer-guide/getting-started_installation.html){rel="noopener nofollow noreferrer"
    target="_blank"}
  - [Reference](https://docs.aws.amazon.com/aws-sdk-php/v3/api/api-s3-2006-03-01.html){rel="noopener nofollow noreferrer"
    target="_blank"}
  - [Example](https://docs.aws.amazon.com/sdk-for-php/v3/developer-guide/s3-examples-creating-buckets.html){rel="noopener nofollow noreferrer"
    target="_blank"}
...
- Minio SDK
  ...
  - [Reference](https://docs.min.io/docs/java-client-api-reference.html){rel="noopener nofollow noreferrer"
    target="_blank"}

- Amazon aws-sdk-java

  - [Installation](https://docs.aws.amazon.com/sdk-for-java/latest/developer-guide/get-started.html){rel="noopener nofollow noreferrer"
    target="_blank"}
  - [Reference](https://sdk.amazonaws.com/java/api/latest/software/amazon/awssdk/services/s3/S3Client.html){rel="noopener nofollow noreferrer"
    target="_blank"}
  - [Example](https://docs.aws.amazon.com/sdk-for-java/latest/developer-guide/examples-s3-objects.html){rel="noopener nofollow noreferrer"
    target="_blank"}
...
- Minio SDK
  ...
  - [Reference](https://docs.min.io/docs/dotnet-client-api-reference.html){rel="noopener nofollow noreferrer"
    target="_blank"}
...
- Minio SDK
  - [Reference](https://docs.min.io/docs/haskell-client-api-reference.html){rel="noopener nofollow noreferrer"
    target="_blank"}
:::
::::::
...
1.  [S3](https://garagehq.deuxfleurs.fr/documentation/build/others/#s3){.font-semibold
    .text-gray-800 .transition-all .hover:text-garage-orange}
    - [PHP](https://garagehq.deuxfleurs.fr/documentation/build/others/#php){#link-php
      .toc .text-gray-700 .hover:text-garage-orange}
    - [Java](https://garagehq.deuxfleurs.fr/documentation/build/others/#java){#link-java
      .toc .text-gray-700 .hover:text-garage-orange}
    - [.NET](https://garagehq.deuxfleurs.fr/documentation/build/others/#net){#link-net
      .toc .text-gray-700 .hover:text-garage-orange}
    - [C++](https://garagehq.deuxfleurs.fr/documentation/build/others/#c){#link-c
      .toc .text-gray-700 .hover:text-garage-orange}
    - [Haskell](https://garagehq.deuxfleurs.fr/documentation/build/others/#haskell){#link-haskell
      .toc .text-gray-700 .hover:text-garage-orange}
...
.h-6 .mx-auto} [Build your own app]{.mt-0.5 .2xl:hidden}
]{.icon}](https://garagehq.deuxfleurs.fr/documentation/build/ "Build your own app"){.flex
