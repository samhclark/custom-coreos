...
# Python {#python .title .leading-10 .text-xl .lg:text-2xl .xl:text-3xl .text-garage-orange .font-semibold}
...
Then instantiate a client object using garage root domain, api key and
secret:

``` {.language-python data-lang="python" style="background-color:#2b303b;color:#c0c5ce;"}
import minio
...
[Reference](https://docs.min.io/docs/python-client-api-reference.html){rel="noopener nofollow noreferrer"
target="_blank"}
...
- [Installation](https://boto3.amazonaws.com/v1/documentation/api/latest/guide/quickstart.html){rel="noopener nofollow noreferrer"
  target="_blank"}
- [Reference](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/s3.html){rel="noopener nofollow noreferrer"
  target="_blank"}
- [Example](https://boto3.amazonaws.com/v1/documentation/api/latest/guide/s3-uploading-files.html){rel="noopener nofollow noreferrer"
  target="_blank"}
...
You need at least Python 3.6, pip, and setuptools. Because the python
package is in a subfolder, the command is a bit more complicated than
usual:
...
Now, let imagine you have a fresh Garage instance running on localhost,
with the admin API configured on port 3903 with the bearer `s3cr3t`:
...
*This example is named `short.py` in the example folder. Other python
examples are also available.*

See also:

- [sdk
  repo](https://git.deuxfleurs.fr/garage-sdk/garage-admin-sdk-python){rel="noopener nofollow noreferrer"
  target="_blank"}
- [examples](https://git.deuxfleurs.fr/garage-sdk/garage-admin-sdk-generator/src/branch/main/example/python){rel="noopener nofollow noreferrer"
  target="_blank"}
:::
::::::
...
1.  [S3](https://garagehq.deuxfleurs.fr/documentation/build/python/#s3){.font-semibold
    .text-gray-800 .transition-all .hover:text-garage-orange}
    - [Using Minio
      SDK](https://garagehq.deuxfleurs.fr/documentation/build/python/#using-minio-sdk){#link-using-minio-sdk
      .toc .text-gray-700 .hover:text-garage-orange}
    - [Using Amazon
      boto3](https://garagehq.deuxfleurs.fr/documentation/build/python/#using-amazon-boto3){#link-using-amazon-boto3
      .toc .text-gray-700 .hover:text-garage-orange}
2.  [K2V](https://garagehq.deuxfleurs.fr/documentation/build/python/#k2v){.font-semibold
    .text-gray-800 .transition-all .hover:text-garage-orange}
3.  [Admin
    API](https://garagehq.deuxfleurs.fr/documentation/build/python/#admin-api){.font-semibold
    .text-gray-800 .transition-all .hover:text-garage-orange}
