...
# Binary packages {#binary-packages .title .leading-10 .text-xl .lg:text-2xl .xl:text-3xl .text-garage-orange .font-semibold}
...
[garage](https://pkgs.alpinelinux.org/packages?name=garage){rel="noopener nofollow noreferrer"
target="_blank"} package from the Alpine Linux repositories (available
since v3.17):
...
The default configuration file is installed to `/etc/garage.toml`. You
can run Garage using: `rc-service garage start`. If you don\'t specify
`rpc_secret`, it will be automatically replaced with a random string on
the first start.

Please note that this package is built without Consul discovery,
Kubernetes discovery, OpenTelemetry exporter, and K2V features (K2V will
be enabled once it\'s stable).

## Arch Linux

Garage is available in the
[AUR](https://aur.archlinux.org/packages/garage){rel="noopener nofollow noreferrer"
target="_blank"}.
...
1.  [Alpine
    Linux](https://garagehq.deuxfleurs.fr/documentation/cookbook/binary-packages/#alpine-linux){.font-semibold
    .text-gray-800 .transition-all .hover:text-garage-orange}
2.  [Arch
    Linux](https://garagehq.deuxfleurs.fr/documentation/cookbook/binary-packages/#arch-linux){.font-semibold
    .text-gray-800 .transition-all .hover:text-garage-orange}
3.  [FreeBSD](https://garagehq.deuxfleurs.fr/documentation/cookbook/binary-packages/#freebsd){.font-semibold
    .text-gray-800 .transition-all .hover:text-garage-orange}
4.  [NixOS](https://garagehq.deuxfleurs.fr/documentation/cookbook/binary-packages/#nixos){.font-semibold
    .text-gray-800 .transition-all .hover:text-garage-orange}
