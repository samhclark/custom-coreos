...
# Deploying with Ansible {#deploying-with-ansible .title .leading-10 .text-xl .lg:text-2xl .xl:text-3xl .text-garage-orange .font-semibold}
...
While Ansible is not officially supported to deploy Garage, several
community members have published Ansible roles. We list them and compare
them below.

## Comparison of Ansible roles

  Feature                              [ansible-role-garage](https://garagehq.deuxfleurs.fr/documentation/cookbook/ansible/#zorun-ansible-role-garage)   [garage-docker-ansible-deploy](https://garagehq.deuxfleurs.fr/documentation/cookbook/ansible/#moan0s-garage-docker-ansible-deploy)   [eddster2309 ansible-role-garage](https://garagehq.deuxfleurs.fr/documentation/cookbook/ansible/#eddster2309-ansible-role-garage)
  ------------------------------------ ----------------------------------------------------------------------------------------------------------------- ------------------------------------------------------------------------------------------------------------------------------------ -----------------------------------------------------------------------------------------------------------------------------------
...
[Source
code](https://github.com/zorun/ansible-role-garage){rel="noopener nofollow noreferrer"
target="_blank"}, [Ansible
galaxy](https://galaxy.ansible.com/zorun/garage){rel="noopener nofollow noreferrer"
target="_blank"}
...
Some more features might be added, such as a way to automatically
connect nodes to each other or to define a layout.

## moan0s/garage-docker-ansible-deploy {#moan0s-garage-docker-ansible-deploy}

[Source
code](https://github.com/moan0s/garage-docker-ansible-deploy){rel="noopener nofollow noreferrer"
target="_blank"}, [Blog
post](https://hyteck.de/post/garage/){rel="noopener nofollow noreferrer"
target="_blank"}

This role is based on the Docker image for Garage, and comes with
\"batteries included\": it will additionally install Docker and Traefik.
In addition, it is \"opinionated\" in the sense that it expects a
particular deployment structure (one instance per disk, one gateway per
host, structured DNS names, etc).

As a result, this role makes it easier to start with Garage on Ansible,
but is less flexible.

## eddster2309/ansible-role-garage {#eddster2309-ansible-role-garage}

[Source
code](https://github.com/eddster2309/ansible-role-garage){rel="noopener nofollow noreferrer"
target="_blank"}, [Ansible
galaxy](https://galaxy.ansible.com/ui/standalone/roles/eddster2309/garage/){rel="noopener nofollow noreferrer"
target="_blank"}

This role is a opinionated but customisable role using the official
Garage static binaries and only requires Systemd. As such it should work
on any Linux based host. It includes all the nesscary configuration to
...
1.  [Comparison of Ansible
    roles](https://garagehq.deuxfleurs.fr/documentation/cookbook/ansible/#comparison-of-ansible-roles){.font-semibold
    .text-gray-800 .transition-all .hover:text-garage-orange}
2.  [zorun/ansible-role-garage](https://garagehq.deuxfleurs.fr/documentation/cookbook/ansible/#zorun-ansible-role-garage){.font-semibold
    .text-gray-800 .transition-all .hover:text-garage-orange}
3.  [moan0s/garage-docker-ansible-deploy](https://garagehq.deuxfleurs.fr/documentation/cookbook/ansible/#moan0s-garage-docker-ansible-deploy){.font-semibold
    .text-gray-800 .transition-all .hover:text-garage-orange}
4.  [eddster2309/ansible-role-garage](https://garagehq.deuxfleurs.fr/documentation/cookbook/ansible/#eddster2309-ansible-role-garage){.font-semibold
    .text-gray-800 .transition-all .hover:text-garage-orange}
