...
# Garage CLI {#garage-cli .title .leading-10 .text-xl .lg:text-2xl .xl:text-3xl .text-garage-orange .font-semibold}
...
The Garage CLI is mostly self-documented. Make use of the `help`
subcommand and the `--help` flag to discover all available options.
:::
::::::
