#!/bin/bash
# GENERATED by generate-quadlets.py from quadlets/radarr.toml — DO NOT EDIT
# ABOUTME: Ensures the _nas_radarr rootless service account has the state
# required for a lingering user manager.

set -euo pipefail

USER_NAME="_nas_radarr"
USER_UID="51420"
USER_HOME="/var/home/_nas_radarr"
USER_SHELL="/sbin/nologin"
USER_SUBID_START="514200000"
