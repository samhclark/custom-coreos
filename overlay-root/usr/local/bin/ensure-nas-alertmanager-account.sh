#!/bin/bash
# GENERATED by generate-quadlets.py from quadlets/alertmanager.toml — DO NOT EDIT
# ABOUTME: Ensures the _nas_alertmanager rootless service account has the state
# required for a lingering user manager.

set -euo pipefail

USER_NAME="_nas_alertmanager"
USER_UID="51240"
USER_HOME="/var/home/_nas_alertmanager"
USER_SHELL="/sbin/nologin"
USER_SUBID_START="512400000"
USER_SUBID_COUNT="65536"
ASSETS_FCONTEXT="/usr/share/custom-coreos/alertmanager(/.*)?"
