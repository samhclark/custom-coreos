#!/bin/bash
# GENERATED by generate-quadlets.py from quadlets/immich-machine-learning.toml — DO NOT EDIT
# ABOUTME: Ensures the _nas_immichmachinelearning rootless service account has the state
# required for a lingering user manager.

set -euo pipefail

USER_NAME="_nas_immichmachinelearning"
USER_UID="51160"
USER_HOME="/var/home/_nas_immichmachinelearning"
USER_SHELL="/sbin/nologin"
USER_SUBID_START="511600000"
