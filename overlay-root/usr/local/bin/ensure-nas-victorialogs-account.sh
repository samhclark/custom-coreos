#!/bin/bash
# GENERATED by generate-quadlets.py from quadlets/victoria-logs.toml — DO NOT EDIT
# ABOUTME: Ensures the _nas_victorialogs rootless service account has the state
# required for a lingering user manager.

set -euo pipefail

USER_NAME="_nas_victorialogs"
USER_UID="51270"
USER_HOME="/var/home/_nas_victorialogs"
USER_SHELL="/sbin/nologin"
USER_SUBID_START="512700000"
