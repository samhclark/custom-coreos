...
# ABOUTME: Ensures the _nas_immichdatabase rootless service account has the state
# required for a lingering user manager.

set -euo pipefail

USER_NAME="_nas_immichdatabase"
USER_UID="51140"
USER_HOME="/var/home/_nas_immichdatabase"
USER_SHELL="/sbin/nologin"
USER_SUBID_START="511400000"
