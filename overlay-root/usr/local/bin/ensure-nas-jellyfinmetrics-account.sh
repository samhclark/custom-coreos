...
# ABOUTME: Ensures the _nas_jellyfinmetrics rootless service account has the state
# required for a lingering user manager.

set -euo pipefail

USER_NAME="_nas_jellyfinmetrics"
USER_UID="51260"
USER_HOME="/var/home/_nas_jellyfinmetrics"
USER_SHELL="/sbin/nologin"
USER_SUBID_START="512600000"
USER_SUBID_COUNT="65536"
ASSETS_FCONTEXT="/usr/share/custom-coreos/jellyfin-exporter(/.*)?"
