...
# ABOUTME: Ensures the _nas_jellyfin rootless service account has the state
# required for a lingering user manager.

set -euo pipefail

USER_NAME="_nas_jellyfin"
USER_UID="51120"
USER_HOME="/var/home/_nas_jellyfin"
USER_SHELL="/sbin/nologin"
USER_SUBID_START="511200000"
