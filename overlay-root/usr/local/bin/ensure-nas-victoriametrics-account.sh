...
# ABOUTME: Ensures the _nas_victoriametrics rootless service account has the state
# required for a lingering user manager.

set -euo pipefail

USER_NAME="_nas_victoriametrics"
USER_UID="51250"
USER_HOME="/var/home/_nas_victoriametrics"
USER_SHELL="/sbin/nologin"
USER_SUBID_START="512500000"
USER_SUBID_COUNT="65536"
ASSETS_FCONTEXT="/usr/share/custom-coreos/victoria-metrics(/.*)?"
