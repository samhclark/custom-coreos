#!/bin/bash
# GENERATED by generate-quadlets.py from quadlets/prowlarr.toml — DO NOT EDIT
# ABOUTME: Ensures the _nas_prowlarr rootless service account has the state
# required for a lingering user manager.

set -euo pipefail

USER_NAME="_nas_prowlarr"
USER_UID="51430"
USER_HOME="/var/home/_nas_prowlarr"
USER_SHELL="/sbin/nologin"
USER_SUBID_START="514300000"
