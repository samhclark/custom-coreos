#!/bin/bash
# GENERATED by generate-quadlets.py from quadlets/immich-server.toml — DO NOT EDIT
# ABOUTME: Ensures the _nas_immichserver rootless service account has the state
# required for a lingering user manager.

set -euo pipefail

USER_NAME="_nas_immichserver"
USER_UID="51130"
USER_HOME="/var/home/_nas_immichserver"
USER_SHELL="/sbin/nologin"
USER_SUBID_START="511300000"
