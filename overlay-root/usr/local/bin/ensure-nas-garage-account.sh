...
# ABOUTME: Ensures the _nas_garage rootless service account has the state
# required for a lingering user manager.

set -euo pipefail

USER_NAME="_nas_garage"
USER_UID="51110"
USER_HOME="/var/home/_nas_garage"
USER_SHELL="/sbin/nologin"
USER_SUBID_START="511100000"
USER_SUBID_COUNT="65536"
ASSETS_FCONTEXT="/usr/share/custom-coreos/garage(/.*)?"
