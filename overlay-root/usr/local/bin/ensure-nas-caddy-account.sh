...
# ABOUTME: Ensures the _nas_caddy rootless service account has the state
# required for a lingering user manager.

set -euo pipefail

USER_NAME="_nas_caddy"
USER_UID="51310"
USER_HOME="/var/home/_nas_caddy"
