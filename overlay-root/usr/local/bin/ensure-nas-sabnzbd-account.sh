#!/bin/bash
# GENERATED by generate-quadlets.py from quadlets/sabnzbd.toml — DO NOT EDIT
# ABOUTME: Ensures the _nas_sabnzbd rootless service account has the state
# required for a lingering user manager.

set -euo pipefail

USER_NAME="_nas_sabnzbd"
USER_UID="51440"
USER_HOME="/var/home/_nas_sabnzbd"
USER_SHELL="/sbin/nologin"
USER_SUBID_START="514400000"
