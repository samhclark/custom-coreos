#!/bin/bash
# GENERATED by generate-quadlets.py from quadlets/sonarr.toml — DO NOT EDIT
# ABOUTME: Ensures the _nas_sonarr rootless service account has the state
# required for a lingering user manager.

set -euo pipefail

USER_NAME="_nas_sonarr"
USER_UID="51410"
USER_HOME="/var/home/_nas_sonarr"
USER_SHELL="/sbin/nologin"
USER_SUBID_START="514100000"
