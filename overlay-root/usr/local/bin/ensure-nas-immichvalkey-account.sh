#!/bin/bash
# GENERATED by generate-quadlets.py from quadlets/immich-valkey.toml — DO NOT EDIT
# ABOUTME: Ensures the _nas_immichvalkey rootless service account has the state
# required for a lingering user manager.

set -euo pipefail

USER_NAME="_nas_immichvalkey"
USER_UID="51150"
USER_HOME="/var/home/_nas_immichvalkey"
USER_SHELL="/sbin/nologin"
USER_SUBID_START="511500000"
